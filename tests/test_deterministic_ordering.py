...
def test_unordered_required(gql_client: utils.GraphQLTestClient):
...
@pytest.mark.django_db(transaction=True)
def test_unordered_optional(gql_client: utils.GraphQLTestClient):
...
@pytest.mark.django_db(transaction=True)
def test_unordered_list(gql_client: utils.GraphQLTestClient):
...
@pytest.mark.django_db(transaction=True)
def test_unordered_connection(gql_client: utils.GraphQLTestClient):
...
@pytest.mark.django_db(transaction=True)
def test_unordered_paginated(gql_client: utils.GraphQLTestClient):
